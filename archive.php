...
<main id="main-content" class="archive-main-content">
		    <?php
		        ...
		        */
		        ...
		        /* --------------------------- POSTS BY CATEGORY --------------------------- */
		        if (perch_get('cat')) {
		            echo '<h1>Archive of: '.perch_category(perch_get('cat'), array ('template'=>'blog_archive_cat.html',),true).'</h1>';
				...
				?>
				<section class="archive-categories-and-tags-section">
